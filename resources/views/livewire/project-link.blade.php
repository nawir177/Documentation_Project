<label class="relative block mb-5">
    ...
    <input
         wire:model="seah" class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border-none rounded-md h-10 pl-9 pr-3 shadow-md focus:outline-nosm focus:ring-indigo-700 focus:ring-1 text-md sm:text-t"
        placeholder="Search for files..." type="text" name="search">
</label>
<input type="text" wire:model="search" value="facebook" name="" id="">
<div>
    ...
    <div class="overflow-x-auto relative shadow rounded-lg max-h-96 overflow-y-scroll">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <livewire:link-single :value="$value" :key="$value->id"/>
